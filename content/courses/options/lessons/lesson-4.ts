...
export const lesson4: Lesson = {
  ...
  phases: [
    ...
    },
    {
      ...
      formulas: [
        [
          `\\sigma = 0.20 \\quad T = 1 \\quad N = 3`,
          `\\Delta t = 1/3 \\approx 0.3333`
        ],
        [
          `u = e^{\\sigma \\sqrt{\\Delta t}} \\quad d = e^{-\\sigma \\sqrt{\\Delta t}}`
        ],
        [
          `\\begin{aligned} u &= e^{0.20 \\sqrt{0.3333}} \\\\ &= e^{0.20 \\times 0.5774} \\\\ &= e^{0.1155} \\\\ &\\approx 1.1224 \\end{aligned}`
        ],
        [
          `\\begin{aligned} d &= e^{-0.20 \\sqrt{0.3333}} \\\\ &\\approx 0.8910 \\end{aligned}`
        ]
      ]
    },
    {
