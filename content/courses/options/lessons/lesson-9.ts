...
export const lesson9: Lesson = {
  ...
  phases: [
    ...
    },
    {
      ...
      visibleParams: [],
      stepTexts: [
        "Imagine you put \\$100 into a risk-free bank account at a 5% interest rate. After 1 year, you would have exactly \\$105.13.",
        ...
        "So, the weighted average of our three future states must equal the bank's return.",
