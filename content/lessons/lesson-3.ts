...
export const lesson3: Lesson = {
  ...
  phases: [
    ...
    {
      id: 'delta-tree',
      title: 'Dynamic Hedging Over Time',
      ...
      stepTexts: [
        ...
        "Step 1: At t=1, our delta changes! If the stock goes up, we need 0.785 shares. If it goes down, we need 0.267 shares. This is 'Dynamic Hedging'.",
